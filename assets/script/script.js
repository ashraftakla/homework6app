...
$(document).ready(function () {
    ...
    $(document).ready(function () {
        ...
        function displayPresentCityInformation(cityData, cityName) {
            ...
            var temperature = $('<p class="temp"></p>').text("Temperature: " + kToF(cityData.current.temp).toFixed(0) + "°F");
            ...
            var uvIndex = $(`<p class="uvIndex"></p>`).text("UV Index: ");
            var uvSpan = $(`<span style="background-color:${uvColor}; color:white;"></span>`).text(cityData.current.uvi)
        ...
        function addDailyForecast(day, cityData) {
            ...
            var temp = $('<p class="daily-temp"></p>').text(`Temp: ${kToF(cityData.daily[day].temp.day).toFixed(0)}°F`);
